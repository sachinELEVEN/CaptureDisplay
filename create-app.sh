...
#pyinstaller --noconsole --name CaptureDisplay --icon=./assets/CaptureDisplay.icns /Users/sachinjeph/Desktop/CaptureDisplay/main.py
...
#for ntoarzation use below signing key
